...
\begin{figure}[!h]
\centering
\includegraphics[width=1.3\textwidth, angle=270] {classFront1.png}
\caption{Class diagram for frontend part 1}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=1.3\textwidth, angle=270] {classFront2.png}
\caption{Class diagram for frontend part 2}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=1.3\textwidth, angle=270] {classBack.jpg}
\caption{Class diagram for backend}
\end{figure}
