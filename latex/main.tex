...
\thispagestyle{empty}
\lipsum[7]
\Signature{Trondheim}{Hallvard Jore Christensen}{Øyvind Hellenes}{Jon-Andre Brurberg}{Tor Barstad}{Vegard Storm}{Jørgen Rugelsjøen Wikdahl}
\cleardoublepage
...
The summarys from the meetings are written in norwegian, and translating them for the report was not something we prioritized.\\
Here is an example:
