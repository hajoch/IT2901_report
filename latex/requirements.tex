...
One of the main reasons for using the Titanium-framework is that it is possible to code once, and compile it down to native applications for a number of smartphone environments. Because of iOS developer requirements, the former application has unfortunately never been tested on iOS, which is a goal set by the customer.
